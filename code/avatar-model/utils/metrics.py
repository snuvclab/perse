...
def fid_score(pred, gt=None, mask=None, use_mask=False):
    if gt == "ffhq":
        score = fid.compute_fid(pred, dataset_name="FFHQ", dataset_res=1024, dataset_split="trainval70k")
    elif gt == "metfaces":
        score = fid.compute_fid(pred, dataset_name="MetFaces", dataset_res=1024, dataset_split="train")
    else:
        score = fid.compute_fid(pred, gt)
    print('[INFO] FID score: ', score)
